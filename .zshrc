...
plugins=(git virtualenv history-substring-search npm)
...
alias gpr='open "$(git config --get remote.origin.url | cut -d''.'' -f1,2 )/compare/$(git branch-name)?expand=1"'
